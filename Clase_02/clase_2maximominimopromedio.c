...
float calcularPromedio(int sumaNumeros,int cantidadNumerosIngresados,float *calculoPromedio);
...
float calcularPromedio(int sumaNumero,int cantidadNumerosIngresados,float *calculoPromedio)
{
